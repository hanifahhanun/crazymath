<?php
	...
	if (isset($_POST['submit1'])){
		...
		//setting nama sesuai aturan(nama userr-tanggal.ext)
		...
		//set session nama file untuk di upload ke database
...
<body>
	...
	<?php
		...
		if ($_SESSION['lives'] == 0){
			...
			setcookie('lasttime', date('d/m/Y H:i:s'), time()+3600*24*7);

			include "dbconfig.php";
			$db = mysqli_connect("localhost", "root", "123456", "crazy_math");
	...
	<form method="post" action="action.php">
		...
		<input type="text" name="hasil" autofocus="true">
